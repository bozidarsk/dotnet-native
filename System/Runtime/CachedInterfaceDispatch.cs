...
#pragma warning restore 8500
        ...
        private static IntPtr RhpCidResolve_Worker(object pObject, IntPtr pCell)
        {
            ...
            RH.RhpGetDispatchCellInfo((InterfaceDispatchCell*)pCell, out cellInfo);
            ...
            if (pTargetCode != IntPtr.Zero)
            {
                ...
                {
                    return RH.RhpUpdateDispatchCellCache((InterfaceDispatchCell*)pCell, pTargetCode, pObject.GetMethodTable(), ref cellInfo);
                }
                else
                {
                    return pTargetCode;
            ...
            Environment.FailFast("Valid method implementation was not found.");
            return IntPtr.Zero;
        }
        ...
        private static IntPtr RhpResolveInterfaceMethod(object pObject, IntPtr pCell)
        {
            ...
            IntPtr pTargetCode = default; // RH.RhpSearchDispatchCellCache((InterfaceDispatchCell*)pCell, pInstanceType);
            if (pTargetCode == IntPtr.Zero)
            {
        ...
        private static unsafe IntPtr RhResolveDispatchWorker(object pObject, void* cell, ref DispatchCellInfo cellInfo)
        {
            ...
            else
            {
                ...
                {
                    cellInfo = InternalTypeLoaderCalls.ConvertMetadataTokenDispatch(RH.RhGetModuleFromPointer(cell), cellInfo);
                ...
                return InternalTypeLoaderCalls.ResolveMetadataTokenDispatch(RH.RhGetModuleFromPointer(cell), (int)cellInfo.MetadataToken, new IntPtr(pInstanceType));
#else
                Environment.FailFast("Runtime internal error.");
                return IntPtr.Zero;
#endif
            }
        }
